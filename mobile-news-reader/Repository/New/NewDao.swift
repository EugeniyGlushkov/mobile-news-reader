...
class NewDao: NewDaoProtocol {
    ...
    func add(new: NewTO) {
        ...
        guard let addedNew =
        NSEntityDescription.insertNewObject(forEntityName: "EntityNew", into: helper.context) as? EntityNew else {
            return
        }
        ...
        addedNew.description_new = new.description_new
    ...
    func remove(bySourceId source_id: String,
        ...
        let fetchRequest: NSFetchRequest<EntityNew> = EntityNew.fetchRequest()
    ...
    private func get(bySourceId source_id: String,
                     ...
                     byAuthor author: String,
                     byTitle title: String,
                     fetchRequest: NSFetchRequest<EntityNew>) -> EntityNew? {
